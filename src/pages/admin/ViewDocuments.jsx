...
const MISSING_ROWS = [
  ...
  { id: 5, name: 'Emma Wilson', email: 'emma.wilson@gmail.com', joined: 'January 27, 2026', files: 'MOA' },
  { id: 6, name: 'Liam Carter', email: 'liam.carter@gmail.com', joined: 'January 27, 2026', files: 'NDA' },
  { id: 7, name: 'Mia Johnson', email: 'mia.johnson@gmail.com', joined: 'January 28, 2026', files: 'MOA/NDA' },
  { id: 8, name: 'Noah Brown', email: 'noah.brown@gmail.com', joined: 'January 28, 2026', files: 'MOA' },
  { id: 9, name: 'Olivia Green', email: 'olivia.green@gmail.com', joined: 'January 29, 2026', files: 'NDA' },
  { id: 10, name: 'Ethan Rivera', email: 'ethan.rivera@gmail.com', joined: 'January 29, 2026', files: 'MOA/NDA' },
  { id: 11, name: 'Sophia Clark', email: 'sophia.clark@gmail.com', joined: 'January 30, 2026', files: 'MOA' },
  { id: 12, name: 'Lucas Martin', email: 'lucas.martin@gmail.com', joined: 'January 30, 2026', files: 'NDA' },
];
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">Review and verify the submitted documents.</p>
            </div>
            <button
              type="button"
